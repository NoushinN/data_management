...
The `map()` function allows us to apply the same operation across all datasets efficiently. The `skimr` package can also generate compact summaries for exploratory data analysis @skimr.

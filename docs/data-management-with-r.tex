...
If referencing this project, please cite: Nabavi, N. \emph{Data Management with R: Practical Teaching Materials for Reproducible Data Wrangling and Analysis}. {[}\href{https://doi.org/10.5281/zenodo.20750322}{DOI}
...
A good project structure helps you keep related files together and reduces the likelihood of errors. It also makes collaboration easier because other users can understand the workflow more quickly. Bookdown provides a framework for creating reproducible books and technical documents directly from R Markdown files Xie (\citeproc{ref-xie2016}{2016}). Reproducible workflows are an important component of modern data analysis Xie (\citeproc{ref-xie2015}{2015}).
...
In this chapter, you will learn how to identify join keys, understand common join relationships, and use functions such as \texttt{left\_join()} and \texttt{inner\_join()} to combine datasets safely and effectively. The \texttt{dplyr} package provides powerful tools for joining relational datasets Wickham et al. (\citeproc{ref-dplyr}{2026}).
...
\begin{verbatim}
## [1] "Corr_2016 copy.csv"           
## [2] "Corr_2016.csv"                
## [3] "Data Dictionary - Blank.xlsx" 
## [4] "Data Dictionary - Filled.xlsx"
## [5] "deaths_2016.xlsx"             
## [6] "Population_Estimates.csv"     
## [7] "titanic.csv"                  
## [8] "Titantic_DataDictionary.xlsx" 
## [9] "Weather_data.csv"
\end{verbatim}
...
\begin{verbatim}
## [1] "Data Dictionary - Blank.xlsx" 
## [2] "Data Dictionary - Filled.xlsx"
## [3] "deaths_2016.xlsx"             
...
##  Min.   :1000001   Length:60143       Length:60143      
##  1st Qu.:1016187   Class :character   Class :character  
##  Median :1034842   Mode  :character   Mode  :character  
##  Mean   :1036699                                        
##  3rd Qu.:1056221                                        
##  Max.   :1080708                                        
##                                                         
##    dbuid2016         Location_of_death Marital_status
##  Min.   :1.001e+10   Min.   :1.000     Min.   :1.0   
##  1st Qu.:2.466e+10   1st Qu.:2.000     1st Qu.:1.0   
##  Median :3.521e+10   Median :4.000     Median :1.0   
##  Mean   :3.642e+10   Mean   :3.498     Mean   :1.5   
##  3rd Qu.:4.715e+10   3rd Qu.:5.000     3rd Qu.:2.0   
##  Max.   :6.208e+10   Max.   :6.000     Max.   :2.0   
##  NA's   :4                                           
##   Postalcode            B_year        B_month      
##  Length:60143       Min.   :1827   Min.   : 1.000  
##  Class :character   1st Qu.:1933   1st Qu.: 4.000  
##  Mode  :character   Median :1941   Median : 7.000  
##                     Mean   :1942   Mean   : 6.513  
##                     3rd Qu.:1951   3rd Qu.:10.000  
##                     Max.   :2016   Max.   :28.000  
##                     NA's   :24     NA's   :26      
##      B_day           D_year        D_month      
##  Min.   : 1.00   Min.   :2016   Min.   : 1.000  
##  1st Qu.: 8.00   1st Qu.:2016   1st Qu.: 4.000  
##  Median :16.00   Median :2016   Median : 7.000  
##  Mean   :15.74   Mean   :2016   Mean   : 6.521  
##  3rd Qu.:23.00   3rd Qu.:2016   3rd Qu.: 9.000  
##  Max.   :31.00   Max.   :2016   Max.   :21.000  
##  NA's   :26                                     
##      D_day      
##  Min.   : 1.00  
##  1st Qu.: 8.00  
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dplyr}\SpecialCharTok{::}\FunctionTok{glimpse}\NormalTok{(pop, }\AttributeTok{width =} \DecValTok{60}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
## Rows: 51
## Columns: 25
## $ ...1                           <dbl> 0, 0, 0, 11, 11, 11~
## $ `Health Service Delivery Area` <chr> "British Columbia",~
## $ Year                           <dbl> 2016, 2016, 2016, 2~
## $ Gender                         <chr> "M", "F", "T", "M",~
## $ `<1`                           <dbl> 22997, 21760, 44757~
## $ `04-Jan`                       <dbl> 93211, 88300, 18151~
## $ `09-May`                       <dbl> 121341, 112777, 234~
## $ `14-Oct`                       <dbl> 119586, 112424, 232~
## $ `15-19`                        <dbl> 140451, 132226, 272~
## $ `20-24`                        <dbl> 170968, 156161, 327~
## $ `25-29`                        <dbl> 159609, 159389, 318~
## $ `30-34`                        <dbl> 162416, 166826, 329~
## $ `35-39`                        <dbl> 155936, 157628, 313~
## $ `40-44`                        <dbl> 151311, 154187, 305~
## $ `45-49`                        <dbl> 161823, 166603, 328~
## $ `50-54`                        <dbl> 172367, 179295, 351~
## $ `55-59`                        <dbl> 172667, 178878, 351~
## $ `60-64`                        <dbl> 156654, 159977, 316~
## $ `65-69`                        <dbl> 139068, 142469, 281~
## $ `70-74`                        <dbl> 99527, 103484, 2030~
## $ `75-79`                        <dbl> 69574, 77160, 14673~
## $ `80-84`                        <dbl> 49268, 57639, 10690~
## $ `85-89`                        <dbl> 28898, 40789, 69687~
## $ `90+`                          <dbl> 13366, 28648, 42014~
## $ Total                          <dbl> 2361038, 2396620, 4~
\end{verbatim}
...
##  Median :31.00   Mode  :character            
##  Mean   :29.06                               
##  3rd Qu.:42.00                               
##  Max.   :53.00                               
##       Year         Gender                <1       
##  Min.   :2016   Length:51          Min.   :  276  
##  1st Qu.:2016   Class :character   1st Qu.:  714  
##  Median :2016   Mode  :character   Median : 1425  
##  Mean   :2016                      Mean   : 3510  
##  3rd Qu.:2016                      3rd Qu.: 2802  
##  Max.   :2016                      Max.   :44757  
##      04-Jan           09-May           14-Oct      
##  Min.   :  1356   Min.   :  1755   Min.   :  1811  
##  1st Qu.:  3118   1st Qu.:  4194   1st Qu.:  3910  
##  Median :  5663   Median :  8002   Median :  7808  
##  Mean   : 14236   Mean   : 18362   Mean   : 18197  
##  3rd Qu.: 11025   3rd Qu.: 15384   3rd Qu.: 15350  
##  Max.   :181511   Max.   :234118   Max.   :232010  
##      15-19            20-24            25-29       
##  Min.   :  1919   Min.   :  1577   Min.   :  1640  
##  1st Qu.:  4240   1st Qu.:  4214   1st Qu.:  4169  
##  Median :  8836   Median :  9193   Median :  8646  
##  Mean   : 21386   Mean   : 25657   Mean   : 25019  
##  3rd Qu.: 17866   3rd Qu.: 22940   3rd Qu.: 21291  
##  Max.   :272677   Max.   :327129   Max.   :318998  
##      30-34            35-39            40-44       
##  Min.   :  2069   Min.   :  2092   Min.   :  2008  
##  1st Qu.:  4415   1st Qu.:  4572   1st Qu.:  4483  
##  Median :  8830   Median :  9490   Median :  9551  
##  Mean   : 25823   Mean   : 24593   Mean   : 23961  
##  3rd Qu.: 22644   3rd Qu.: 21896   3rd Qu.: 21345  
##  Max.   :329242   Max.   :313564   Max.   :305498  
##      45-49            50-54            55-59       
##  Min.   :  2040   Min.   :  2137   Min.   :  2038  
##  1st Qu.:  4859   1st Qu.:  5431   1st Qu.:  5684  
##  Median :  9930   Median : 10666   Median : 10972  
##  Mean   : 25759   Mean   : 27581   Mean   : 27572  
##  3rd Qu.: 23211   3rd Qu.: 24455   3rd Qu.: 22498  
##  Max.   :328426   Max.   :351662   Max.   :351545  
##      60-64            65-69            70-74       
##  Min.   :  1550   Min.   :  1119   Min.   :   784  
##  1st Qu.:  5349   1st Qu.:  5006   1st Qu.:  3628  
##  Median : 10698   Median : 10011   Median :  7256  
##  Mean   : 24834   Mean   : 22081   Mean   : 15922  
##  3rd Qu.: 19486   3rd Qu.: 16891   3rd Qu.: 12128  
##  Max.   :316631   Max.   :281537   Max.   :203011  
##      75-79            80-84            85-89      
##  Min.   :   538   Min.   :   351   Min.   :  196  
##  1st Qu.:  2332   1st Qu.:  1612   1st Qu.:  973  
##  Median :  5026   Median :  3867   Median : 2636  
##  Mean   : 11509   Mean   :  8385   Mean   : 5466  
##  3rd Qu.:  9268   3rd Qu.:  6582   3rd Qu.: 4543  
##  Max.   :146734   Max.   :106907   Max.   :69687  
##       90+              Total        
##  Min.   :  114.0   Min.   :  32171  
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dplyr}\SpecialCharTok{::}\FunctionTok{glimpse}\NormalTok{(corr, }\AttributeTok{width =} \DecValTok{60}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
## Rows: 420,963
## Columns: 6
## $ dbuid2016      <dbl> 10010165001, 10010165002, 100101650~
## $ csduid2016     <dbl> 1001519, 1001519, 1001519, 1001519,~
## $ hruid2017      <dbl> 1011, 1011, 1011, 1011, 1011, 1011,~
## $ hrname_english <chr> "Eastern Regional Health Authority"~
## $ hrname_french  <chr> "Eastern Regional Health Authority"~
## $ dbpop2016      <dbl> 160, 25, 268, 53, 71, 217, 39, 120,~
\end{verbatim}
...
\begin{verbatim}
##    dbuid2016           csduid2016        hruid2017   
##  Min.   :1.001e+10   Min.   :1001101   Min.   :1011  
##  1st Qu.:2.466e+10   1st Qu.:2466023   1st Qu.:2414  
##  Median :3.558e+10   Median :3558090   Median :3595  
##  Mean   :3.856e+10   Mean   :3855572   Mean   :3856  
##  3rd Qu.:4.806e+10   3rd Qu.:4806016   3rd Qu.:4832  
##  Max.   :6.208e+10   Max.   :6208098   Max.   :6201  
##                                                      
##  hrname_english     hrname_french        dbpop2016      
##  Length:420963      Length:420963      Min.   :   0.00  
...
\begin{verbatim}
##  POSTALCODE12        WTHNRC12_01     WTHNRC12_02    
##  Length:116011      Min.   :19.28   Min.   :-46.74  
##  Class :character   1st Qu.:31.07   1st Qu.:-11.44  
##  Mode  :character   Median :31.28   Median : -8.40  
##                     Mean   :31.62   Mean   :-11.67  
##                     3rd Qu.:31.76   3rd Qu.: -7.49  
##                     Max.   :39.07   Max.   : -4.48  
##   WTHNRC12_03      WTHNRC12_04      WTHNRC12_05    
##  Min.   :-2.605   Min.   : 2.913   Min.   :-8.122  
##  1st Qu.: 9.693   1st Qu.:13.454   1st Qu.: 5.750  
##  Median :10.140   Median :13.887   Median : 6.612  
##  Mean   : 9.573   Mean   :13.521   Mean   : 5.625  
##  3rd Qu.:10.449   3rd Qu.:14.006   3rd Qu.: 6.893  
##  Max.   :10.551   Max.   :16.227   Max.   : 7.132  
...
## Rows: 60,143
## Columns: 13
## $ ID                <dbl> 1000001, 1000002, 1000003, 10000~
## $ Sex               <chr> "M", "F", "M", "M", "M", "F", "F~
## $ Cause_of_death    <chr> "D47", "C34", "C26", "C16", "C22~
## $ dbuid2016         <dbl> 13070175019, 48060924001, 352045~
## $ Location_of_death <dbl> 5, 3, 6, 1, 6, 5, 4, 1, 3, 2, 5,~
## $ Marital_status    <dbl> 1, 1, 2, 1, 1, 1, 1, 1, 1, 2, 2,~
## $ Postalcode        <chr> "E1A1E9", "T2E0T2", "M4J1L1", "H~
## $ B_year            <dbl> 1943, 1943, 1953, 1923, 1931, 19~
## $ B_month           <dbl> 7, 5, 8, 6, 8, 11, 5, 8, 7, 2, 1~
## $ B_day             <dbl> 8, 22, 9, 14, 8, 4, 20, 18, 23, ~
## $ D_year            <dbl> 2016, 2016, 2016, 2016, 2016, 20~
## $ D_month           <dbl> 9, 12, 4, 11, 4, 2, 2, 6, 5, 1, ~
## $ D_day             <dbl> 22, 14, 21, 21, 4, 6, 9, 13, 25,~
\end{verbatim}
...
Some age-group variables contain names such as \texttt{"04-Jan"} or \texttt{"09-May"}, which are not ideal variable names for analysis.The \texttt{janitor} package is also useful for cleaning messy column names and inspecting datasets Firke (\citeproc{ref-janitor}{2026}).
...
## # i 5 more variables: Ticket <chr>, Fare <dbl>,
## #   Cabin <chr>, Embarked <chr>, family_size <dbl>
\end{verbatim}
...
## $ newrel_f65   <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, N~
\end{verbatim}
...
The chapter also introduces several important visualization techniques using \texttt{ggplot2}, which will help you explore and validate your cleaned datasets. The \texttt{ggplot2} package is based on the Grammar of Graphics framework Wickham (\citeproc{ref-wickham2017}{2017}). Data visualization in this book is primarily based on the \texttt{ggplot2} package Wickham (\citeproc{ref-ggplot2pkg}{2026a}).
...
\begin{verbatim}
## # A tibble: 1,071 x 5
##    Health Service Delivery A~1  Year Gender Age   Population
##    <chr>                       <dbl> <chr>  <chr>      <dbl>
##  1 British Columbia             2016 M      ...1           0
##  2 British Columbia             2016 M      <1         22997
##  3 British Columbia             2016 M      01-04      93211
...
## 10 British Columbia             2016 M      35-39     155936
## # i 1,061 more rows
## # i abbreviated name: 1: `Health Service Delivery Area`
\end{verbatim}
...
\NormalTok{  ) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}
    \AttributeTok{breaks =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{breaks\_pretty}\NormalTok{(}\AttributeTok{n =} \DecValTok{5}\NormalTok{),}
...
\includegraphics[width=1\linewidth]{data-management-with-r_files/figure-latex/06-visualization-population-line-plot-1}
...
\includegraphics[width=1\linewidth]{data-management-with-r_files/figure-latex/06-visualization-population-bar-plot-1}
...
\NormalTok{  ) }\SpecialCharTok{+}
  ...
  \FunctionTok{facet\_wrap}\NormalTok{(}
    \SpecialCharTok{\textasciitilde{}}\NormalTok{ HSDA,}
    \AttributeTok{ncol =} \DecValTok{2}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}
    \AttributeTok{breaks =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{breaks\_pretty}\NormalTok{(}\AttributeTok{n =} \DecValTok{4}\NormalTok{),}
    \AttributeTok{labels =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{label\_comma}\NormalTok{()}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
...
\includegraphics[width=1\linewidth]{data-management-with-r_files/figure-latex/06-visualization-population-facets-1}
...
## # i 60,133 more rows
## # i 5 more variables: B_month <dbl>, B_day <dbl>,
## #   D_year <dbl>, D_month <dbl>, D_day <dbl>
\end{verbatim}
...
## # i 43 more rows
## # i 8 more variables: B_month <dbl>, B_day <dbl>,
...
## # i 48,672 more rows
## # i 18 more variables: Postalcode <chr>, B_year <dbl>,
...
## #   hrname_english <chr>, hrname_french <chr>, ...
\end{verbatim}
...
The \texttt{map()} function allows us to apply the same operation across all datasets efficiently. The \texttt{skimr} package can also generate compact summaries for exploratory data analysis Waring et al. (\citeproc{ref-skimr}{2026}).
...
Firke, Sam. 2026. \emph{Janitor: Simple Tools for Examining and Cleaning Dirty Data}. \url{https://cran.r-project.org/package=janitor}.

\bibitem[\citeproctext]{ref-skimr}
Waring, Elin, Michael Quinn, Amelia McNamara, Eduardo Arino de la Rubia, Hao Zhu, and Shannon Ellis. 2026. \emph{Skimr: Compact and Flexible Summaries of Data}. \url{https://cran.r-project.org/package=skimr}.

\bibitem[\citeproctext]{ref-wickham2017}
Wickham, Hadley. 2017. \emph{Ggplot2: Elegant Graphics for Data Analysis}. 2nd ed. Springer.

\bibitem[\citeproctext]{ref-ggplot2pkg}
---------. 2026a. \emph{Ggplot2: Create Elegant Data Visualisations Using the Grammar of Graphics}. \url{https://ggplot2.tidyverse.org/}.

\bibitem[\citeproctext]{ref-stringr}
---------. 2026b. \emph{Stringr: Simple, Consistent Wrappers for Common String Operations}. \url{https://stringr.tidyverse.org/}.

\bibitem[\citeproctext]{ref-wickham2023}
Wickham, Hadley, Mine Çetinkaya-Rundel, and Garrett Grolemund. 2023. \emph{R for Data Science}. O'Reilly Media. \url{https://r4ds.hadley.nz/}.

\bibitem[\citeproctext]{ref-dplyr}
Wickham, Hadley, Romain François, Lionel Henry, and Kirill Müller. 2026. \emph{Dplyr: A Grammar of Data Manipulation}. \url{https://dplyr.tidyverse.org/}.
...
---------. 2016. \emph{Bookdown: Authoring Books and Technical Documents with r Markdown}. Chapman; Hall/CRC. \url{https://bookdown.org/yihui/bookdown/}.

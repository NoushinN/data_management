...
By the end of this chapter, you should be able to load packages, inspect project files, import CSV and Excel data, explore data structure, reshape population data, and recode values safely.

## Chapter overview

This chapter introduces the mortality, population, correspondence, and environmental datasets. It also introduces basic data exploration, file inspection, column-name cleaning, and reshaping data from wide to long format.
